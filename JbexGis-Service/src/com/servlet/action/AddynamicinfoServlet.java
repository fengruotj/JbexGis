...
public class AddynamicinfoServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9016828594428817394L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		long flag = TPersonaldynamicAction.addPersonaldynamic(username, dotX, dotY , detail,
				time);
