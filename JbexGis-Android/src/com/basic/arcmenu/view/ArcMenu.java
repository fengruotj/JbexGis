package com.basic.arcmenu.view;
...
public class ArcMenu extends ViewGroup implements OnClickListener
{
		...
		if (changed)
		{
			...
			for (int i = 0; i < count - 1; i++)
			{
                ...
                if(mPosition==Position.CENTER){
                	cl=(int) (getMeasuredWidth()/2-mRadius* Math.cos(Math.PI /(count )*(i+1))-cWidth/2);
                	ct=(int) (getMeasuredHeight()/2-mRadius*Math.sin(Math.PI /(count )*(i+1))-cHeight/2);
                }
	...
	/**
	 * 涓哄綋鍓嶇偣鍑荤殑Item璁剧疆鍙樺ぇ鍜岄�鏄庡害闄嶄綆鐨勫姩鐢�
	 * 
	 * @param duration
	 * @return
	 */
