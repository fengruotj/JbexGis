...
public static final int MESSAGE_TYPE_ADD_FRIEND=3;
	...
	public static final int REQUEST_SEND_JBEXFriend=26;
	...
	public static final int RECEIVE_JBEXFriend=504;
	...
	public static final int SEND_NOTIFICATION_JBEX_FRIEND=2001;
	
	public static final int COONECT_SERVER_SUCCESS=3000;
	
	public static final int finFrienduser=4000;
	
	public static final int SEND_MessageFragment=5000;
	
	public static final int SEND_MessageOffline=6000;
	
	public final static int DateBase_SEND_MESSAGE=222;
	public final static int DateBase_GET_MESSAGE=333;
}
